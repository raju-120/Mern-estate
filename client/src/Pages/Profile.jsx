  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <Link  to={"/create-listing"} className='bg-green-700 text-white p-3 rounded-lg uppercase text-center hover:opacity-50'>
          Create Listing
        </Link>
              ...
              userListings.map((listing) =>(
                <div 
                  key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'>
                    ...
                    <Link to={`/listing/${listing._id}`} className='flex-1 font-semibold hover:underline truncate '>
                      <p>{listing.name}</p>
                    </Link>
